...
<table class="table table-striped"><thead><tr><th>N°</th><th>Fecha</th><th>Cliente</th><th>Vendedor</th><th>Producto</th><th>Cantidad</th></tr></thead><tbody>
<?php foreach($actas as $a): ?>
<tr><td><?= htmlspecialchars($a['numero']) ?></td><td><?= htmlspecialchars($a['fecha']) ?></td><td><?= htmlspecialchars($a['cliente_nombre'].' ('.$a['cliente_codigo'].')') ?></td><td><?= htmlspecialchars($a['vendedor_codigo']) ?></td><td><?= htmlspecialchars($a['producto']) ?></td><td><?= $a['cantidad'] ?></td></tr>
<?php endforeach; ?>
</tbody></table>
